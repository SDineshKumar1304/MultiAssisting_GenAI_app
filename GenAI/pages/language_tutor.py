...
st.title("I am LangAI 👨‍🏫🏫")
st.title("Lets Make a Convo 🤓")
st.snow()
st.balloons()
...
st.image("C:\\Users\\svani\\Downloads\\Data_Science_tutor\\Main_convo.jpg")
...
instructions="You are a Language Expert tutor,you need to teach any language in a simple way "
